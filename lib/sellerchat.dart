...
// version to update online/off line
...
// version to update chat again to modify 
...
//     try {
//       final response = await http.get(
//         Uri.parse('$baseUrl/chats?sellerId=${widget.sellerId}'),
//         headers: {
//           'Content-Type': 'application/json',
//           'Authorization': 'Bearer ${widget.token}',
//         },
...
//         final data = jsonDecode(response.body);
//         setState(() {
//           _chatList = List<Map<String, dynamic>>.from(data['chats'] ?? []);
...
//             });
//           }
//           _selectedChat = _chatList.firstWhere(
...
//     try {
//       final response = await http.get(
//         Uri.parse('$baseUrl/chat/${_selectedChat!['chatId']}'),
//         headers: {
//           'Content-Type': 'application/json',
//           'Authorization': 'Bearer ${widget.token}',
//         },
...
//   Future<void> _fetchChatDetails() async {
//     try {
//       print('Fetching chat details for chatId: ${_selectedChat!['chatId']}');
//       final response = await http.get(
//         Uri.parse('$baseUrl/chat/${_selectedChat!['chatId']}'),
//         headers: {
//           'Content-Type': 'application/json',
...
//     socket.onConnect((_) {
//       print('Seller connected to Socket.io server');
//       socket.emit('joinChat', _selectedChat!['chatId']);
//       socket.emit('online', _selectedChat!['chatId']);
//     });

//     socket.on('receiveMessage', (data) {
//       if (data['senderId'] != widget.sellerId && data['chatId'] == _selectedChat!['chatId']) {
//         setState(() {
//           _messages.add({
//             'senderId': data['senderId'],
//             'message': data['message'],
...
//     socket.on('messageSeen', (data) {
//       print('Received messageSeen: $data');
//       if (data['messageTimestamp'] != null && data['chatId'] == _selectedChat!['chatId']) {
//         try {
//           final receivedTime = DateTime.parse(data['messageTimestamp']);
//           setState(() {
//             _messages = _messages.map((msg) {
...
//     socket.onDisconnect((_) {
//       print('Seller disconnected from Socket.io server');
//       socket.emit('offline', _selectedChat!['chatId']);
//     });
...
//   void _reinitializeSocket(String newChatId) {
//     socket.emit('offline', _selectedChat!['chatId']);
//     socket.disconnect();
//     socket.dispose();
...
//                         }).toList(),
//                         onChanged: (newChat) {
//                           if (newChat != null && newChat['chatId'] != _selectedChat!['chatId']) {
//                             setState(() {
//                               _selectedChat = newChat;
//                               _isLoading = true;
//                               _messages = [];
//                               _isChatDetailsLoaded = false;
//                               _clientName = null;
//                               _clientProfileImage = null;
//                               _isLoadingClientProfile = true;
//                               _productId = null;
...
//                               _currentDiscount = null;
//                             });
//                             _reinitializeSocket(newChat['chatId']);
//                             _fetchMessages();
//                             _fetchChatDetails();
//                           }
//                         },
...
//                     ),
//                     onChanged: (value) {
//                       socket.emit('typing', _selectedChat!['chatId']);
//                     },
//                   ),
//                 ),
//                 const SizedBox(width: 8),
