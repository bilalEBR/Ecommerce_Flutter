...
//       leading: Icon(
//         icon,
//         color: isSelected ? Colors.yellow : Colors.black12,
//       ),
//       title: Text(
//         title,
//         style: GoogleFonts.poppins(
...
class _AdminPageState extends State<AdminPage> {
  ...
  void didChangeDependencies() {
    super.didChangeDependencies();
    _pages = [
      const HomePage(), // Placeholder for external HomePage
      const UsersPage(),
      const OrdersPage(),
      const ReviewsPage(),
      const ProductsPage(),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.purple, // Match SellerHomePage
        title: Text(
          'Admin Panel', // Static title like SellerHomePage
          style: GoogleFonts.poppins(
            fontSize: 20,
            fontWeight: FontWeight.bold,
            color: Colors.white,
        ...
        child: ListView(
          ...
          children: [
            UserAccountsDrawerHeader(
              ...
              decoration: const BoxDecoration(
                color: Colors.purple, // Match SellerHomePage
              ),
            ),
            ListTile(
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const Center(
      child: Text(
        'Home Page - Moved to External File',
